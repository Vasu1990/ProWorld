...
(function (vm) {
    ...
    vm.confirmFriend = function (data) {
    ...
    vm.dataSource = function (options, callback) {
        ...
        var _searchTable = dataFormCollection.GlobalSearchText.value;
        proWorld.AjaxHelper.GetCall("/Home/GetUserCountByName?SearchTable=" + _searchTable, OnSuccessGetFreiendCount);
