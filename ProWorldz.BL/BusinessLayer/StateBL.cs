   ...
   public class StateBL
    {
        ...
        public List<StateBM> GetStateByCountry(int Id)
        {
            return uow.StateRepository.Find(a => a.CountryId == Id).ConvertAll<StateBM>(new Converter<State, StateBM>(ConvertToBM));
        }
